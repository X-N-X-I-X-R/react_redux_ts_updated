...
import { Box, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Paper, Button, TextField, MenuItem, Typography, Select, InputLabel, FormControl, Snackbar } from '@mui/material';
import moment from 'moment-timezone';
import styled from '@emotion/styled';
import { countries } from 'countries-list'; // קבלת רשימת המדינות

const StyledTableCellFirstColumn = styled(TableCell)`
  border-right: 2px solid #9c27b0;
`;

const StyledTableCellSecondColumn = styled(TableCell)``;
