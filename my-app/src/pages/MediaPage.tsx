...
const MediaPage: React.FC = () => {
  ...
  return (
    <Box padding="20px" sx={{ fontFamily: 'Arial, sans-serif'}}>
      ...
      <Box display="flex" justifyContent="space-around" marginTop="20px">
        ...
        <Card sx={{ minWidth: 300, boxShadow: 3, borderRadius: 2 }}>
          <CardContent>
      ...
      <Box marginTop="20px">
        <Card sx={{ boxShadow: 3, borderRadius: 2 }}>
          <CardContent>
            ...
            {images.length === 0 ? (
              <Typography variant="body1" sx={{ color: '#607d8b', textAlign: 'center', padding: '20px' }}>
                This is the time to start sharing memories with friends!
              </Typography>
            ) : (
